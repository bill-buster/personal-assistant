...
> 📚 **Documentation Index**: See [docs/INDEX.md](docs/INDEX.md) for all documentation organized by topic.  
> 🚀 **How We Work**: See [docs/HOW_WE_WORK.md](docs/HOW_WE_WORK.md) for complete workflow guide.
